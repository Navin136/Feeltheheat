...
function chargemix(){
    ...
    if(grade == "sg-tin" || grade =="sg-copper" || grade =="sg-azterlan"){
        document.querySelector(".result").innerHTML = `Bath carbon is ${bathcarbon}%.<br> You need to add ${haddition} Kgs of Hi-Carbon or ${naddition} Kgs of Neograf <br>Bath silicon is ${bathsilicon}%.<br> You need to add ${fesiaddition} Kgs of FerroSilicon to achieve required chemistry`;
    }
    if(grade == "sg-lowmoly" || grade == "sg-highmoly" || grade == "cg-moly"){
        ...
        document.querySelector(".result").innerHTML = `Bath carbon is ${bathcarbon}%.<br> You need to add ${haddition} Kgs of Hi-Carbon or ${naddition} Kgs of Neograf <br>Bath silicon is ${bathsilicon}%.<br> You need to add ${fesiaddition} Kgs of FerroSilicon<br>Bath molybdenum is ${bathmolybdenum}%.<br> You need to add ${femoaddition} Kgs of FerroMolybdenum to achieve required chemistry`;
    }
    if(grade == "simoni"){
        let bathmolybdenum = ((document.getElementById("wsteel").value*0.01+document.getElementById("wreturns").value*rmolybdenum)/furnaceweight).toFixed(2);
        let femoaddition = ((pmolybdenum-bathmolybdenum)*furnaceweight/60).toFixed(2)
        ...
        document.querySelector(".result").innerHTML = `Bath carbon is ${bathcarbon}%.<br> You need to add ${haddition} Kgs of Hi-Carbon or ${naddition} Kgs of Neograf <br>Bath silicon is ${bathsilicon}%.<br> You need to add ${fesiaddition} Kgs of FerroSilicon<br>Bath molybdenum is ${bathmolybdenum}%.<br> You need to add ${femoaddition} Kgs of FerroMolybdenum<br>Bath Nickel is ${bathnickel}%.<br> You need to add ${niaddition} Kgs of Pure Nickel to achieve required chemistry`;
    }
}
